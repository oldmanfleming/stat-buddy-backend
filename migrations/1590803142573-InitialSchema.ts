...
export class InitialSchema1590803142573 implements MigrationInterface {
    name = 'InitialSchema1590803142573'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f3a17aac3cf52bdeadc253c58d" ON "events" ("timestamp", "eventType", "playTime", "gameType", "teamStrength", "opposingStrength", "teamScore", "opposingTeamScore") `, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "shifts" ("timestamp" TIMESTAMP NOT NULL, "gamePk" integer NOT NULL, "gameType" character varying NOT NULL, "playerId" integer NOT NULL, "isHome" boolean NOT NULL, "teamId" integer NOT NULL, "opposingTeamId" integer NOT NULL, "teamStrength" integer NOT NULL, "opposingStrength" integer NOT NULL, "teamScore" integer NOT NULL, "opposingTeamScore" integer NOT NULL, "startTime" integer NOT NULL, "endTime" integer NOT NULL, "length" integer NOT NULL, "playerIdId" integer, "teamIdId" integer, "opposingTeamIdId" integer, CONSTRAINT "PK_6cd5e7e03ee1b808d7b535d71f8" PRIMARY KEY ("gamePk", "playerId", "startTime"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_344656c9e09a354f0637272eac" ON "shifts" ("timestamp", "startTime", "endTime", "gameType", "teamStrength", "opposingStrength", "teamScore", "opposingTeamScore") `, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "shifts" ADD CONSTRAINT "FK_1b0077a4d5ddeecc7b8a6df53ff" FOREIGN KEY ("playerIdId") REFERENCES "players"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "shifts" ADD CONSTRAINT "FK_1711139ecc9e02b8156f1908cb1" FOREIGN KEY ("teamIdId") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "shifts" ADD CONSTRAINT "FK_1a0bf49e367152db7a15af80a0f" FOREIGN KEY ("opposingTeamIdId") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "shifts" DROP CONSTRAINT "FK_1a0bf49e367152db7a15af80a0f"`, undefined);
        await queryRunner.query(`ALTER TABLE "shifts" DROP CONSTRAINT "FK_1711139ecc9e02b8156f1908cb1"`, undefined);
        await queryRunner.query(`ALTER TABLE "shifts" DROP CONSTRAINT "FK_1b0077a4d5ddeecc7b8a6df53ff"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "IDX_344656c9e09a354f0637272eac"`, undefined);
        await queryRunner.query(`DROP TABLE "shifts"`, undefined);
        await queryRunner.query(`DROP TABLE "results"`, undefined);
        await queryRunner.query(`DROP INDEX "IDX_f3a17aac3cf52bdeadc253c58d"`, undefined);
